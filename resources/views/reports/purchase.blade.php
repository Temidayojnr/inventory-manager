                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
...
<script>
    function exportF(elem) {
        ...
        elem.setAttribute("download", "purchase-export.xls"); // Choose the file name
        return false;
    }
</script>
...
<script type="text/javascript">
    function generate() {
        ...
        var y = 20;
        doc.setLineWidth(2);
        doc.text(200, y = y + 30, "Purchase Report");
        doc.autoTable({
            html: '#table',
            startY: 70,
            theme: 'grid',

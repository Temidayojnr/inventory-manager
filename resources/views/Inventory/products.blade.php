            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table project-list-table table-nowrap table-centered table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
